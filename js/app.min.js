...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/me03.jpg" alt="Bryan Smith"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Fletcher Burton  </td></tr>
					<tr><td>Profession</td><td>Full Stack Developer</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Resume</td><td><a href="" download>Download Resume</a></td></tr>
					<tr><td>Portfolio</td><td><a href="https://majestic-froyo-df301a.netlify.app/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:burtoncreations@tuta.io"><i class="fas fa-envelope"></i></a>
              <a href="https://www.linkedin.com/in/fletcher-burton/" target="_blank"><i class="fab fa-linkedin"></i></a>
              <a href="https://github.com/developer-33" target="_blank"><i class="fab fa-github"></i></a>
              <a href="https://www.instagram.com/developer33/" target="_blank"><i class="fab fa-instagram"></i></a>
              <a href="https://twitter.com/developer33" target="_blank"><i class="fab fa-twitter"></i></a>
              <a href="https://www.facebook.com/fletcher.burton" target="_blank"><i class="fab fa-facebook"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    height: 350,
    html: `
			<div class= "louisiana-map-wrap">
				<img class="finland-map" src="${imagePath}/usa-la.svg" alt="Finland Map">
  ...
  },
  {
    title: "logo",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/logo.jpg" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="">Weather App</a></td><td>Express React</td><td>2022</td><td><a href="#" onclick="modal(event)" data-title="Arter Oy">Full Report</a></td></tr>

					<tr><td><a target="_blank" href="/">Project 2</a></td><td></td><td>2023 - 2012</td><td><a href="#" onclick="modal(event)" data-title="Oivan">Full Report</a></td></tr>
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>Go</td></tr>
						<tr><td>NodeJS</td><td>Express</td></tr>
				<tr><td>JSX</td><td>React</td></tr>
				<tr><td>SQL</td><td>TailwindCss</td></tr>
			</tbody>
		</table>`,
  },
  {
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'loading Fletcher Burton\'s Portfolio',
        typing: true,
      },
      {
        text: "Access Granted",
...
var missions = {
  ...
  "Weather App": `
		...
		<h3>The Name  of the  Project</h3>
    <p>▪ Developed a weather application using React.js</p>
